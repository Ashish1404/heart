const Joi = require('joi')
  ...
  , eventWiseReportService = require('../service/reportService/eventWiseReport');
...
module.exports = {
  ...
  sportsWiseUsersPL: async function (req, res) {
    try {
      const { params, parent_id, user_name } = await reportService.extractUserParams(req);
      const result = await reportService.sportsWiseUsersPL(params);

      const response = { user_name, parent_id, data: result.data };
  ...
  eventWisePlReport: function (req, res) {
    return eventWiseReportService.eventWisePlReport(req)
      .then(result => {
        if (result.statusCode != SUCCESS)
          return ResError(res, { msg: result.data });
        return ResSuccess(res, result.data);
  ...
  sportsWiseUsersPLDiamond: async function (req, res) {
    try {
      const { params, parent_id, user_name } = await reportService.extractUserParams(req) || {};
      const result = await reportService.sportsWiseUsersPLDiamond(params);
      let response = { user_name, parent_id, data: result.data };
