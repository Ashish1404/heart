...
module.exports = () => {
  ...
  eventRoutes.post('/updateMarketWiseLimites', userActivityLogger, EventValidator.updateMarketWiseLimites, EventsController.updateMarketWiseLimites);
  eventRoutes.post('/getMarketWiseLimites', userActivityLogger, EventValidator.getMarketWiseLimites, EventsController.getMarketWiseLimites);
  eventRoutes.post('/addOrUpdateMarketFancyCatName', userActivityLogger, EventValidator.addOrUpdateMarketFancyCatName, EventsController.addOrUpdateMarketFancyCatName);
  return eventRoutes;
};