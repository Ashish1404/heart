...
module.exports = (socket) => {
  ...
  matchesRoutes.post('/activeuserCount', matchValidator.userCount, matchController.userCount);
  matchesRoutes.post('/totaluserCount', matchValidator.userCount, matchController.totaluserCount);
