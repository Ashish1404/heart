...
module.exports = () => {
  ...
  accountStatementRoutes.post('/diamondChipSummary', AccountStatementValidator.diamondChipSummary, AccountStatementController.diamondChipSummary);
  accountStatementRoutes.post('/diamondSettlementHistory', AccountStatementValidator.diamondSettlementHistory, AccountStatementController.diamondSettlementHistory);
