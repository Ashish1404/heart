...
module.exports = () => {
  ...
  reportRoutes.post('/sportsWiseUsersPL', ReportValidator.sportsWiseUsersPL, ReportController.sportsWiseUsersPL);
  reportRoutes.post('/sportsWiseUsersPLDiamond', ReportValidator.sportsWiseUsersPL, ReportController.sportsWiseUsersPLDiamond);
  ...
  reportRoutes.post('/eventWisePlReport', ReportValidator.eventWisePlReport, ReportController.eventWisePlReport);
  return reportRoutes;
};