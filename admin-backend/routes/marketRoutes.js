...
module.exports = () => {
  ...
  marketRoutes.post(
    "/marketRollbackList",
    marketValidator.marketRollbackList,
    marketController.marketRollbackList
  );
  marketRoutes.post('/createManualRates', 
    marketValidator.createManualRates, 
    marketController.createManualRates
  );
  return marketRoutes;
};