        ...
        '$unionWith': {
          ...
          'pipeline': [
            ...
            },
            {
              '$project': {
                "_id": 0,
                "sportName": BALL_BY_BALL_EVENT_DATA.sport_name,
                "userName": 1,
                "userId": 1,
                "marketType": BALL_BY_BALL_EVENT_DATA.market_name,
                "matchName": BALL_BY_BALL_EVENT_DATA.match_name,
                "marketId": "$roundId",
                "marketName": BALL_BY_BALL_EVENT_DATA.market_name,
                "roundId": 1,
                "calculateExposure": {$multiply: ["$stake", -1]},
                "operatorId": "1",
                "exposureTime": "$updatedAt"
              }
            },
