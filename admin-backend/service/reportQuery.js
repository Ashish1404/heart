...
module.exports = {
  ...
  sportsP_L: function (params) {
    ...
    let matchConditions = { "$match": { 'agents_pl_distribution.user_id': user_id, is_demo: false } };
    if (is_user)
  ...
  matchWiseP_L: function (params) {
    ...
    let { search } = params;
    let matchConditions = { "$match": { 'agents_pl_distribution.user_id': user_id, sport_id, is_demo: false } };
    if (is_user)
  ...
  usersPLByMarket: function (params) {
    ...
    let { search } = params;
    let matchConditions = { "$match": { 'agents_pl_distribution.user_id': user_id, "event_id": market_id, is_demo: false } };
    if (is_user)
