...
const MarketsSchema = new Schema({
  ...
  market_before_inplay_profit: { type: Number, default: VALIDATION.market_before_inplay_profit },
  market_bet_delay: { type: Number, default: VALIDATION.market_bet_delay_default },
  is_series_limit_applicable: { type: Boolean, default: false },
  ...
  result_value_selections: { type: String },
  ...
  // Auto Market Result
  is_auto_market_result: { type: Boolean, default: true },
}, {
  versionKey: false,
  timestamps: true,
  id: false,
